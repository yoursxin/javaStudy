 ...
 * generated in the test.wssope.rand.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _NextNResponse_QNAME = new QName("http://rand.wssope.test/", "nextNResponse");
    private final static QName _Next1Response_QNAME = new QName("http://rand.wssope.test/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://rand.wssope.test/", "nextN");
    private final static QName _Next1_QNAME = new QName("http://rand.wssope.test/", "next1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: test.wssope.rand.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.wssope.test/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.wssope.test/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.wssope.test/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.wssope.test/", name = "next1")
