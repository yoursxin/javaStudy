 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://rand.wssope.test/", wsdlLocation = "http://localhost:8888/rs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RANDSERVICESERVICE_QNAME = new QName("http://rand.wssope.test/", "RandServiceService");
    ...
    public RandService getRandServicePort() {
        return super.getPort(new QName("http://rand.wssope.test/", "RandServicePort"), RandService.class);
    }
    ...
    public RandService getRandServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rand.wssope.test/", "RandServicePort"), RandService.class, features);
    }
